...
const Navbar = () => {
  ...
  return (
    ...
    <div className=" bg-white rounded-2xl justify-center items-center">
          <div className={`flex justify-between relative z-[+1]  duration-500 lg:px-10 px-7 md:static ${extendNavbar ? "h-[350px] pt-5" : "h-[72px] pt-5"}`}>
                <div>
                <img src={bg} alt='' className="h-9" />
                </div>
                <div className=''>
                <ul className={`flex md:flex-row duration-700 md:static absolute xs:flex flex-col lg:gap-7 gap-3 text-gray-800 font-semibold font-[Gelasi]  text-xl  md:text-base lg:text-xl font-[Gelasi] ${extendNavbar ? "left-8 top-24 " : "left-[-200px] top-24"}  `}>
