...
const Contact = () => {
  return (
    ...
    <div>
        <div className="xl:h-[650px] h-48 s:h-[230px] sm:h-[300px] md:h-[400px] lg:h-[480px] bg-cover bg-center" style={{ backgroundImage: `url(${img})` }}>
          <div className="flex  xl:h-screen xl:pr-20 px-2 ">
             ...
             <h1 className="xl:text-[68px] text-[20px] s:text-[32px] sm:text-[45px] md:text-[60px] lg:text-[70px] font-extrabold text-center uppercase xl:leading-[60px] leading-[20px] s:leading-[30px] sm:leading-[40px] md:leading-[50px] lg:leading-[60px] text-[#25282B]">Contact
    ...
    <div className="flex items-center justify-center bg-cover bg-center lg:py-14 py-10 lg:px-16 " style={{ backgroundImage: `url(${img1})` }}>
            <div  className="bg-[#68B9D9] md:p-8 py-6 rounded-3xl px-5 shadow-lg  w-[340px] s:w-[430px] sm:w-[580px] md:w-[660px] lg:w-[750px] xl:w-[1100px] xl:h-[670px] xl:py-10   " >
