...
const Benefits = () => {
  return (
    <div>
        ...
        <div className="h-full flex items-center justify-center bg-cover bg-center py-1 px-4" style={{ backgroundImage: `url(${img1})` }}>
  <div className="flex flex-col items-center px-4 sm:px-10 py-10 md:py-16">
    ...
    <div className="shadow-2xl rounded-lg w-full bg-white px-6 py-12 s:pt-16 md:pt-28 xl:py-32  md:p-10">
