            ...
            <div className="shadow-2xl rounded-lg w-full bg-white px- py-12 s:pt-16 md:pt-28 xl:py-32  md:p-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center items-center justify-center px-2 sm:px-6 md:px-8">
                <div>
                  ...
                  <p className="text-gray-600 mt-2 text-sm sm:text-base font-[Gill_Sans_MT]">We partner with farms that prioritize optimal bird breeds known for producing nutritious eggs ensuring superior quality for our customers.</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2 text-sm sm:text-base font-[Gill_Sans_MT]">We ensure that our partner farms maintain ideal environmental conditions, essential for bird well-being and high-quality egg production.</p>
                </div>
                <div>
